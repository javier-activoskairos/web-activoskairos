...
export function Button({
  ...
  return (
    ...
    >
      {iconLeft && (
        <span style={{ display: "inline-flex", marginLeft: "-0.1em" }}>
          {iconLeft}
        </span>
      )}
      {children}
      {iconRight && (
        <span style={{ display: "inline-flex", marginRight: "-0.1em" }}>
          {iconRight}
        </span>
      )}
    </button>
...
export function Logo({
  ...
  const src =
    variant === "mark"
      ...
      : onDark
        ? `${basePath}assets/logo-wordmark-light.png`
        : `${basePath}assets/logo-wordmark-dark.png`;
      ...
      {tick && (
        <span
          style={{
            ...
            height: 2,
            borderRadius: 2,
            background: tone === "accent" ? "var(--accent)" : "currentColor",
            opacity: tone === "accent" ? 1 : 0.5,
          }}
        />
      )}
      {children}
