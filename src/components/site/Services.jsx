...
const THREAD_SEGMENTS = [
  {
    d: "M20,98 C55,101 70,100 90,100 C175,100 215,58 300,58 C385,58 415,108 500,108 C585,108 615,54 700,54 C785,54 835,96 910,96 C945,96 965,95 980,95",
    delay: 0,
  },
];
const VB_W = 1000,
    ...
    <Section tone="light" id="activos">
      <Container>
        <div style={{ maxWidth: 680, marginBottom: "var(--space-8)" }}>
          <Reveal>
            <Eyebrow tick={false}>El ecosistema Kairos</Eyebrow>
          </Reveal>
          <Reveal
            delay={60}
            as="h2"
          ...
          >
            Empiezas montando tu espacio, construyes los activos que necesitas y
            los mantienes vivos. Eliges el punto donde estás.
          </Reveal>
        </div>
  ...
  return (
    <path
      ...
      style={{
        ...
        transition: reduce
          ? "none"
          : `stroke-dashoffset 760ms cubic-bezier(.33,.9,.4,1) ${delay}ms`,
      }}
    />
  );
}
      ...
      >
        {THREAD_SEGMENTS.map((s, i) => (
          <path
            ...
            d={s.d}
            fill="none"
            stroke="var(--border-strong, rgba(26,23,20,0.12))"
            strokeWidth="2"
            strokeLinecap="round"
            vectorEffect="non-scaling-stroke"
          />
        ...
        return (
          <button
            ...
            style={{
              ...
              transition: reduce
                ? "none"
                : `opacity 420ms ease ${appearDelay}ms, transform 420ms cubic-bezier(.22,.61,.36,1) ${appearDelay}ms`,
            }}
          >
            <span
              className="kairos-node-badge"
              style={{
                display: "flex",
                alignItems: "center",
                ...
                boxShadow:
                  i === active
                    ? "0 0 0 6px rgba(249,99,2,0.10), 0 10px 24px -12px rgba(249,99,2,0.5)"
                    : "var(--shadow-sm, 0 2px 8px rgba(26,23,20,0.06))",
                transition: "border-color 280ms ease, box-shadow 280ms ease",
              }}
            >
              <img
                src={`/assets/products/${it.logo}`}
                alt=""
                aria-hidden="true"
                style={{
                  width: 32,
            ...
            <span
              style={{
                ...
                fontWeight: 700,
                fontSize: 15,
                color: i === active ? "#F96302" : "var(--text-strong)",
    ...
    >
      <div
        ...
        style={
          reduce
            ? {}
            : { animation: "kairosDetailIn 320ms cubic-bezier(.22,.61,.36,1)" }
        }
      >
        <div
          style={{
        ...
        <div
          style={{
            ...
            borderTop: "1px solid var(--border-subtle, rgba(26,23,20,0.08))",
          }}
        >
          <span
            aria-hidden="true"
    ...
    <div style={{ position: "relative", paddingLeft: 4 }}>
      <div
        ...
        style={{
          ...
          transition: reduce
            ? "none"
            : "transform 900ms cubic-bezier(.33,.9,.4,1)",
        }}
      />
      <div
        style={{
            ...
            <React.Fragment key={it.name}>
              <div
                style={{
                  ...
                  alignItems: "flex-start",
                  opacity: inView || reduce ? 1 : 0,
                  transform: inView || reduce ? "none" : "translateY(12px)",
                  transition: reduce
                    ? "none"
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    background: "var(--surface-card, #fff)",
                    border:
                      "1px solid var(--border-subtle, rgba(26,23,20,0.08))",
                    borderRadius: "var(--radius-xl, 16px)",
                    boxShadow: open
                      ? "var(--shadow-md, 0 12px 28px -16px rgba(26,23,20,0.18))"
                      : "var(--shadow-sm, 0 2px 8px rgba(26,23,20,0.05))",
                    padding: "var(--space-5)",
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      transition: reduce
                        ? "none"
                        : "max-height 360ms ease, opacity 300ms ease",
                      marginTop: open ? 12 : 0,
                    }}
                  >
                    <div
                    ...
                    >
                      <span
                        aria-hidden="true"
                        style={{ color: "#F96302", fontWeight: 700 }}
                      >
                        →
                      </span>
                      <span
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 620 }}>
        ...
        >
          Entendemos cómo trabaja tu empresa hoy, detectamos dónde pierdes
          tiempo y te decimos con honestidad si podemos ayudarte y por dónde
