        ...
        >
          ...
          >
            <div>
              ...
              >
                Cuéntanos tu caos. Te mostramos el{" "}
                <span style={{ color: "#F96302" }}>activo</span>.
              </Reveal>
              <Reveal
                delay={120}
                as="p"
              ...
              >
                Una llamada de 30 minutos que funciona como tu primer
                diagnóstico. Salgas o no con nosotros, saldrás con claridad
                sobre qué sistema necesitas.
              </Reveal>
              <Reveal
                delay={170}
                as="p"
              ...
              >
                Hablas directamente con el equipo que diseña tu activo, no con
                un comercial.
              </Reveal>
              <Reveal
                delay={220}
              ...
              >
                {[
                  [<Shield key="s" size={16} />, "Tus datos son tuyos"],
                  [<Clock key="c" size={16} />, "Respuesta en 24 h"],
                  [<Check key="k" size={16} />, "Partner de Notion"],
                ].map(([ic, label], i) => (
                  <span
                    key={i}
                    style={{
                  ...
                  >
                    <span style={{ color: "#F96302", display: "inline-flex" }}>
                      {ic}
                    </span>
                    {label}
                  </span>
            ...
            <Reveal delay={140}>
              {sent ? (
                ...
                >
                  ...
                  />
                  <ContactField
                    label="¿Qué quieres ordenar?"
                    placeholder="Ej. ventas, operaciones, proyectos…"
                    value={fields.goal}
                    onChange={set("goal")}
                    valid={fields.goal.trim().length > 1}
                    optional
                    reduce={reduce}
                  />
                  <button
      ...
      >
        ...
        <span
          ...
          style={{
            ...
            transition: reduce
              ? "none"
              : "opacity 220ms ease, transform 220ms cubic-bezier(.22,.61,.36,1)",
          }}
        >
          <Check size={11} />
        </span>
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "radial-gradient(rgba(245,237,230,0.04) 1px, transparent 1px)",
          backgroundSize: "30px 30px",
          maskImage:
            "radial-gradient(90% 120% at 18% 40%, #000 20%, transparent 72%)",
          WebkitMaskImage:
            "radial-gradient(90% 120% at 18% 40%, #000 20%, transparent 72%)",
        }}
      />
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(249,99,2,0.22) 0%, rgba(249,99,2,0.08) 40%, transparent 68%)",
          filter: "blur(16px)",
        }}
      />
    </div>
...
function ContactShards({ inView, reduce }) {
  ...
  const shards = [
    {
      rest: { left: "3%", top: "8%", rot: -12 },
      set: { left: "5%", top: "12%", rot: -3 },
      w: 90,
    },
    {
      rest: { left: "30%", top: "2%", rot: 9 },
      set: { left: "26%", top: "9%", rot: 2 },
      w: 70,
    },
    {
      rest: { left: "8%", top: "74%", rot: 7 },
      set: { left: "7%", top: "78%", rot: -1 },
      w: 80,
    },
    {
      rest: { left: "34%", top: "82%", rot: -10 },
      set: { left: "30%", top: "84%", rot: 3 },
      w: 64,
    },
  ];
  return (
        ...
        return (
          <span
            ...
            style={{
              ...
              transition: reduce
                ? "none"
                : `opacity 700ms ease ${i * 90}ms, transform 800ms cubic-bezier(.22,.61,.36,1) ${i * 90}ms, left 800ms cubic-bezier(.22,.61,.36,1) ${i * 90}ms, top 800ms cubic-bezier(.22,.61,.36,1) ${i * 90}ms`,
            }}
          />
        );
      })}
      ...
      <Container>
        ...
        >
          <div>
            ...
            >
              Consultoría de IA que centraliza el caos empresarial en activos
              digitales sobre Notion.
            </p>
            <p
              style={{
                margin: "1.2rem 0 0",
              ...
              >
                {links.map((l) => (
                  <a
                    ...
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.color = "#F96302")
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.color = "var(--text-on-dark-body)")
                    }
                  >
                    {l}
                  </a>
