...
export function HeroDashboard({ tilt, reduce }) {
  ...
  return (
    <div
      className="kairos-hero-dash"
      style={{
        transformStyle: "preserve-3d",
        transform: reduce
          ? "none"
          : `rotateX(${rx}deg) rotateY(${ry}deg) translateX(${tx}px)`,
        transition: "transform 320ms cubic-bezier(.22,.61,.36,1)",
        borderRadius: 16,
        border: "1px solid rgba(255,255,255,0.1)",
        background: "linear-gradient(180deg, #1A1917 0%, #141312 100%)",
        boxShadow:
          "0 40px 90px -30px rgba(0,0,0,0.8), 0 0 0 1px rgba(255,255,255,0.03) inset",
        overflow: "hidden",
      }}
    >
      <div
      ...
      <div
        ...
        className="kairos-hero-dashbody"
      >
        <div
          style={{
        ...
        >
          ...
          {rows.map((r, ri) => (
            <div
              ...
              style={{
                ...
                background:
                  ri === highlightRow ? "rgba(249,99,2,0.12)" : "transparent",
                transition: reduce ? "none" : "background 420ms ease",
              }}
            >
              <span style={{ fontSize: 11, fontWeight: 600, color: "#F5EDE6" }}>
                {r[0]}
              </span>
              <StatusChip
                state={r[1]}
                ...
                reduce={reduce}
              />
              <span style={{ fontSize: 11, color: "rgba(245,237,230,0.62)" }}>
                {r[2]}
              </span>
              <span style={{ fontSize: 11, fontWeight: 600, color: "#F5EDE6" }}>
                {r[3]}
          ...
          <div
            style={{
              ...
              borderTop: "1px solid rgba(255,255,255,0.06)",
              opacity: phase >= 3 ? 1 : 0,
              transform: phase >= 3 ? "none" : "translateY(-4px)",
              transition: reduce
                ? "none"
          ...
          >
            ...
            <span
              style={{
                ...
                padding: "2px 7px",
                borderRadius: 999,
                background: "rgba(127,185,139,0.22)",
                color: "#8FC79B",
              }}
            >
              Activo
            ...
            <span
              style={{
                ...
                padding: "2px 6px",
                borderRadius: 999,
                background: "rgba(249,99,2,0.16)",
                color: "var(--kairos-orange-400)",
                whiteSpace: "nowrap",
              }}
            >
              <Sparkles size={9} /> IA
              ...
              {bars.map((h, i) => (
                <span
                  ...
                  style={{
                    ...
                    height: `${h}%`,
                    borderRadius: 3,
                    background: i === 3 ? "#F96302" : "rgba(249,99,2,0.3)",
                    transition: reduce
                      ? "none"
              ...
              >
                <span
                  style={{
                    ...
                    borderRadius: 4,
                    border: "1.5px solid",
                    borderColor: tasksDone
                      ? "#F96302"
                      : "rgba(245,237,230,0.28)",
                    background: tasksDone ? "#F96302" : "transparent",
                    color: "#fff",
                    display: "inline-flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                <span
                  style={{ fontSize: 10.5, color: "rgba(245,237,230,0.62)" }}
                >
                  {tk}
                </span>
              </div>
