  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        overflow: "hidden",
        background: KAIROS_INK_HERO,
        paddingTop: "clamp(112px, 15vh, 168px)",
        paddingBottom: "clamp(0px, 4vw, 40px)",
      }}
    >
      ...
      >
        ...
        >
          Puedes tener tus datos en cualquier lugar,
          <br /> o puedes tenerlos en{" "}
        ...
        >
          <img
            src="/assets/notion-certified-consultant.png"
            alt="Notion Certified Consultant"
            style={{
              height: 50,
              width: "auto",
              display: "block",
    ...
    >
      <div
        style={{
          ...
          maskImage:
            "radial-gradient(120% 90% at 50% 30%, #000 35%, transparent 80%)",
          WebkitMaskImage:
            "radial-gradient(120% 90% at 50% 30%, #000 35%, transparent 80%)",
        }}
      />
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(249,99,2,0.28) 0%, rgba(249,99,2,0.10) 38%, transparent 68%)",
          filter: "blur(20px)",
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(130% 100% at 50% 18%, transparent 40%, rgba(10,9,8,0.55) 100%)",
        }}
      />
      <div
        style={{
